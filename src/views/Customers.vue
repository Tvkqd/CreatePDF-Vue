...
<div class="home">
    ...
    <a class="btn btn-primary" v-on:click="goToSamplePDFPage()"><span style="color:white">Go to Sample PDF Page</span></a>
    <br>
    <a class="btn btn-primary" v-on:click="goToClassPDFPage()"><span style="color:white">Go to Class PDF Page</span></a>
</div>
...
export default {
    ...
    methods: {
        ...
        goToSamplePDFPage: function() {
            this.$router.push("/samplePDF/");
        },
        goToClassPDFPage: function() {
            this.$router.push("/classPDF/");
        }
    }
}
